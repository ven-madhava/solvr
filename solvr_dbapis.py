...
# including global DB name and DB user & pass
# -------------------------------------------
global main_db_name
main_db_name = 'solvrdb'

global main_db_user
main_db_user = 'solvrdbuser'

global main_db_pass
main_db_pass = 'solvrdbuserpassword'
    ...
    *****************************************************
    ...
    if sanity_flag == 1:
        ...
        try:
            ...
            # ---------
            if vm_or_local == 'local':                
                con = psql.connect(host = host, database = main_db_name)
            else:
                con = psql.connect(host = host, database = main_db_name, user = main_db_user, password=main_db_pass)
